...
const FormulaSettings = () => {
    const { co2PerTree, updateFormula } = useCalculation();
    ...
    const handleSave = (e) => {
        ...
        // Simulate API delay
        setTimeout(() => {
            updateFormula({ co2PerTree: val });
            setStatus({ type: "success", message: "Formula updated successfully!" });
            setIsSaving(false);
        }, 800);
    };
        ...
        <div style={{ maxWidth: "600px" }}>
            ...
            <div className="card" style={{ padding: "30px" }}>
                <p style={{ color: "var(--text-muted)", fontSize: "14px", marginBottom: "24px" }}>
                    ...
                    Changes will take effect immediately for all pending and new verifications.
                </p>
